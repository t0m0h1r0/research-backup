...
追加保持費用と，清浄バックアップ保持期間の不足から生じる
復旧不能ペナルティの単期間最適化として定式化する．
...
実効保持期間
\[
  T(n_{\mathrm{ext}})=(n+n_{\mathrm{ext}})\Delta
\]
とする．実行可能集合を
\[
...
\begin{proof}
$T=(n+n_{\mathrm{ext}})\Delta$ として微分すると
\[
