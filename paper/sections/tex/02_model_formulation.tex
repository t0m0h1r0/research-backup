...
全損または復旧完了は一つの更新サイクルの終端であり，費用を計上した
後に正常状態へ再生するとみなす．
...
汚染世代数は早期検知時に $k=\lceil T_{\mathrm{det}}/\Delta\rceil$，
症状検知時に $k=\lceil T_d/\Delta\rceil$ とする．
$k\ge n$ なら全損，$k<n$ なら復旧可能である．
Pareto 尾確率を保持期間で評価する議論では
\[
...
\begin{equation}
  ...
  \label{eq:qfull}
\end{equation}
と定義する．早期検知に成功した分岐の期待費用を
$\Qearly(I)$ と書く．本稿では，早期検知時の封じ込め・隔離費用は
$\Delta$ に依存しないものとして分離する．したがって，定常費用
レートは
\begin{equation}
