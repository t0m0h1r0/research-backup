...
## ON_DEMAND: kernel-ops.md §ARTIFACT-CONVERGENCE-01,§SCHEME-CODE-01,§GIT-00,§AUDIT-01,§EXP-01,§ID-RESERVE-LOCAL,§TOOL-TRUST-01; kernel-roles.md §SCHEMA EXTENSIONS v7.1.0; kernel-workflow.md §DYNAMIC-REPLANNING, §Agent Effort Policy
