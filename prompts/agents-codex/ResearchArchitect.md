...
## AUTHORITY: Route all tasks; HAND-04; ARTIFACT-CONVERGENCE(); CONDENSE(); METRIC(); TOOL-TRUST(); REPLAN(max 2 cycles); merge main only on explicit user request and no-ff.
...
## ON_DEMAND: §HAND-01, §HAND-04, §ARTIFACT-CONVERGENCE-01, §OP-CONDENSE, §K-RETRIEVE, §K-COMPILE, §METRIC-01, §TOOL-TRUST-01, §ID-NAMESPACE-DERIVE/RESERVE/CHECK; §AGENT_EFFORT_POLICY
