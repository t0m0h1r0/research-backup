...
## CONSTRAINTS: run PAPER-WRITE-01 for drafting/expansion/related-work/abstract/substantive revision; for material/iterative revisions use ARTIFACT-CONVERGENCE-01 with consumer=reviewer/reader and native spec=ManuscriptSectionPlan; preserve source scope, limitations, and author perspective; KL-12(\texorpdfstring in headings); P3(consistency P3-A..F); PR-5(paper eq=spec); no figure edits; diff-first.
...
## ON_DEMAND: kernel-ops.md §ARTIFACT-CONVERGENCE-01,§PAPER-WRITE-01,§BUILD-01; kernel-project.md §PR-5
