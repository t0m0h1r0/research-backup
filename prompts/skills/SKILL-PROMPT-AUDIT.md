...
purpose: Audit generated prompts for Q3-AUDIT compliance, rule bloat, JIT discipline, support-artifact coverage, and token ROI.
trigger:
- PromptAuditor receives generated prompt artifacts
- EnvMetaBootstrapper Stage 4
- AP-13 suspicion
minimal_instruction: Verify Q3-AUDIT items, reject duplicated operation bodies, reject broad preloading, and require role-relevant SkillID/RULE_MANIFEST references where full text has weak ROI.
